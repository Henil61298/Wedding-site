...
export function DanceSequence({active,onComplete}) {
  ...
  return <div className="dance-stage">
    ...
    <video ref={video} className="dance-video" src="/media/our-dance.mp4?v=2" muted playsInline preload="auto" aria-label="Henil asks for Vidhi's hand, she joins him and twirls, then they come together" onEnded={onComplete} onError={()=>setError(true)} onPlaying={()=>{setNeedsPlay(false);setError(false)}}/>
